...
cards = "".join([
    ...
    card(IC["receipt"], "Klaster Transaksi",
         "Segmentasi nota/transaksi dengan K-Means++. Kontrol klaster &amp; filter, telusuri profil segmen, lalu unduh.",
         href="klaster-transaksi"),
    ...
    card(IC["chart2"], "Developer &middot; Transaksi",
         "Eksperimen teknis klaster transaksi: Elbow/Silhouette/DBI, PCA 2D/3D, korelasi, pilih K-Means vs K-Means++.",
         href="developer-transaksi"),
])
